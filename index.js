const apiKey = "76d564de067be3bd1672eb068d60de56";
...
async function fetchData(url) {
    try {
        ...
        if (!response.ok) {
            throw new Error("Tarkista internet yhteytesi.");
        }
...
function createMovieCard(movie) {
    ...
    const formattedDate = release_date || "Ei julkaisu päivää";
    const cardTemplate = `
    <div class="column">
    <div class="card">
        ...
        <div class="card-content">
            ...
            <div class="right-content">
                <a href="${imagePath}" target="_blank" class="card-btn">Katso kansikuva</a>
            </div>
        </div>
        <div class="info">
...
function showResults(item) {
    ...
    result.innerHTML += newContent || "<p>Ei tuloksia.</p>";
}
